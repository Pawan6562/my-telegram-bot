...
# --- Flask App for Uptime (Railway isko ignore karega, par code mein rehne se koi dikkat nahi) ---
app = Flask('')
@app.route('/')
def home():
    return "I'm alive!"
...
def run():
    # Railway apne aap port set karta hai, isliye hum ise 8080 par chala sakte hain
...
# --- Main Function ---
def main():
    # keep_alive() # Railway ke liye iski zaroorat nahi hai
    ...
    print("DoreBox Bot (Railway Version) is running!")
