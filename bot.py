...
# --- Flask App (Yeh Render ko "zinda" rakhega) ---
app = Flask(__name__)
...
def run_flask():
    # Render apne aap port set karta hai, isliye hum os.environ.get('PORT', 8080) use karenge
...
def main():
    ...
    # Flask ko ek alag thread mein chalao
    flask_thread = Thread(target=run_flask)
    flask_thread.start()

    # Ab Telegram bot ko chalao
